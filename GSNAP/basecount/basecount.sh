...
find $vcfdir -maxdepth 1 -name 'allbams.vcf'| xargs -I% echo "awk -F'\t' '{print \$1\".\"\$2, \$1, \$2, \$4, \$5;}' % | grep -v '^#' | sort -k 1,1 >"%.pos >cmd.sh
sh cmd.sh
...
vcfdir='/proj/b2012046/rani/analysis/gsnap/varcalls'
bcdir='/proj/b2012046/rani/analysis/gsnap/basecount'

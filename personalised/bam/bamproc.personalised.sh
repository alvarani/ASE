...
sbatchdir='/proj/b2012046/rani/scripts/personalised/bamprocess'
 #/proj/b2012046/rani/scripts/gsnap/multimapped --has the scripts for 19 multi mapped 
bamfile='/proj/b2012046/rani/analysis/degner/personalised/1_LPS.readp_1.1.ill.fastq'
cd $sbatchdir
...
projid='b2012046'
email='alva.rani@scilifelab.se'
sbatchdir='/proj/b2012046/rani/scripts/personalised'
execdir='/bubo/home/h24/alvaj/glob/code/ASE/bam'
bamsort='/proj/b2012046/rani/analysis/degner/personalised/1_LPS.readp_1.1.ill.fastq'
outdir='/proj/b2012046/rani/analysis/degner/personalised/mergebam'
time='1:00:00'
cd $sbatchdir
...
########Create indexes###
bamsort='/proj/b2012046/rani/analysis/degner/personalised'

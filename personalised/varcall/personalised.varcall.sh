...
sbatchdir='/proj/b2012046/rani/scripts/personalised/varcall'
bamfile='/proj/b2012046/rani/analysis/degner/personalised'
...
cd ${vcfdir}
cat allbams.vcf | grep '^#' >header.tmp #/proj/b2012046/rani/analysis/degner/personalised
cat header.tmp | sed 's/\/proj\/b2012046\/rani\/analysis\/degner\/personalised\///g' | sed 's/\.bam//g' >file.tmp
